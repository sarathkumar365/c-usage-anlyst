...
-- ============================================================================
-- Access helpers and policies (members read the last 30 days, or all with the history permission; admins manage aliases; no client writes)
-- ============================================================================
...
-- Only enrolled collector tokens are accepted; admin-issued shared tokens could write as anyone.
